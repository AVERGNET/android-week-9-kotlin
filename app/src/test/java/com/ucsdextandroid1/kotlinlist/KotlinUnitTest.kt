...
class KotlinUnitTest {
     ...
     */
    private fun containsAnyEvenNumbers(collection: Collection<Int>): Boolean = collection.any { it ->
       it % 2 == 0
    }

    @Test
    fun example_4_test() {
        assertEquals(true, containsAnyEvenNumbers(2, 4, 6))
        assertEquals(false, containsAnyEvenNumbers(1, 3, 5, 7))
    }
